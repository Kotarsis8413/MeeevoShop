        ...
        <div>
            ...
            <div className="itempool">
                ...
                <div className="item">
                        ...
                        <div className="m22"><h2>749₽</h2><button className="cartbtn" onClick={() => addToCart(1)}>В корзину</button></div>
                </div>
                <div className="item">
                        <img src="assets/imgs/kalash.png" className="m22"/>
                        <h3 className="m22">Калаш</h3>
                        <div className="m22"><h2>999₽</h2><button className="cartbtn" onClick={() => addToCart(1)}>В корзину</button></div>
                </div>
                <div className="item">
                ...
                <div className="item">
                        ...
                        <div className="m22"><h2>949₽</h2><button className="cartbtn" onClick={() => addToCart(1)}>В корзину</button></div>
                </div>
            </div>
        </div>
    ),
...
function addToCart(item) {
    ...
    window.location = `http://meeevogrup.temp.swtest.ru/MeeevoShop/cart/api.php?name=${name}&pass=${pass}&item=${item}`;
}